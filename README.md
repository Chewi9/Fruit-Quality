...
* Entrenamiento del modelo con más variedad de frutas, verduras y otros alimentos.
* Implementación de cámara en tiempo real.
* Clasificación del tipo de defecto.
